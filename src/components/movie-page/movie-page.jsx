...
const MoviePage = (props) => {
  const {film} = props;
  const {title, genre, releaseDate, imagePoster, imageBackground, ratingScore, ratingCount, description, director, starring} = film;

  return (<React.Fragment>
    <section className="movie-card movie-card--full">
      <div className="movie-card__hero">
        <div className="movie-card__bg">
          <img src={`img/${imageBackground}`} alt={title}/>
        </div>
      ...
      <div className="movie-card__wrap movie-card__translate-top">
        <div className="movie-card__info">
          <div className="movie-card__poster movie-card__poster--big">
            <img src={`img/${imagePoster}`} alt={`${title} poster`} width="218" height="327"/>
          </div>
